...
//				System.out.println(me.getKey().getClass().getName()+"------"+me.getValue().getClass().getName());
				...
				ServiceImpl impl = (ServiceImpl)me.getValue();
				Map pm = impl.getPorts();
				Iterator ipm = pm.entrySet().iterator();
				while( ipm.hasNext() )
				{
					Map.Entry me1 = (Map.Entry )ipm.next();
					PortImpl pi = (PortImpl)me1.getValue();
					Binding b = pi.getBinding();
					System.out.println(b.getBindingOperations());
				}
